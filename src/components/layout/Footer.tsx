            ...
            <div className="space-y-3 text-sm">
              <div className="flex items-start gap-3">
                ...
                <span className="text-white/85">
                  {settings.address || "123 Wellness Street, Downtown District"}
                </span>
              </div>
              ...
              {settings.telegram_username && (
                <div className="flex items-center gap-3">
                  <a
                    href={settings.telegram_username.startsWith('http') ? settings.telegram_username : `https://t.me/${settings.telegram_username.replace('@', '')}`}
                    target="_blank"
              ...
              <div className="flex items-center gap-3">
                ...
                <a
                  href={`mailto:${settings.contact_email || 'info@spafort.com'}`}
                  className="text-white/85 hover:text-white transition-colors"
                >
                  {settings.contact_email || 'info@spafort.com'}
                </a>
              </div>
            </div>
          </div>
