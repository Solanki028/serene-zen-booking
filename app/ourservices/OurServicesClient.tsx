...
export default function OurServicesClient() {
  ...
  useEffect(() => {
    const loadData = async () => {
      try {
        // Load services
        const servicesResponse = await fetch("/api/services/grouped/categories", { cache: "no-store" });
      ...
      <Layout>
        <div className="min-h-screen bg-gradient-to-b from-amber-50 via-white to-emerald-50">
          ...
          <div
            ...
            style={{
              backgroundImage: `url(${heroImage || "/assets/service-traditional.jpg"})`,
                      ...
                      >
                        <div className="px-8 pb-8 pt-4 space-y-8 bg-gradient-to-b from-white to-amber-50/30">
                          {categoryGroup.category.description && (
                            <p className="text-gray-600 text-lg max-w-3xl">{categoryGroup.category.description}</p>
                          )}
                              ...
                              <div className="grid md:grid-cols-3 gap-0">
                                ...
                                <div className="md:col-span-2 p-6 flex flex-col">
                                  <div className="flex-1">
                                    ...
                                    <p className="text-gray-600 text-base leading-relaxed mb-4">{service.shortDesc}</p>
                                      ...
                                      <div className="flex flex-wrap gap-2">
                                        {service.durations.map((duration, idx) => (
                                          ...
                                          >
                                            ...
                                            <span className="text-lg font-bold text-amber-700">₹{duration.price}</span>
                                          </div>
                                        ))}
                                      </div>
